...
export class Cpu {
     ...
     */
    get_reg_a() {
        const ret = wasm.cpu_get_reg_a(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {number}
     */
    get_reg_b() {
        const ret = wasm.cpu_get_reg_b(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {number}
     */
    get_reg_c() {
        const ret = wasm.cpu_get_reg_c(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {number}
     */
    get_reg_d() {
        const ret = wasm.cpu_get_reg_d(this.__wbg_ptr);
        return ret;
    }
}
