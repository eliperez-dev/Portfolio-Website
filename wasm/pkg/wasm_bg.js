...
export class Emulator {
     ...
     */
    get_errors() {
        const ret = wasm.emulator_get_errors(this.__wbg_ptr);
     ...
     */
    get_warnings() {
        const ret = wasm.emulator_get_warnings(this.__wbg_ptr);
        var v1 = getArrayJsValueFromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
    ...
    load_program(code) {
        ...
        wasm.emulator_load_program(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @param {number} val
     */
    resolve_input(val) {
        wasm.emulator_resolve_input(this.__wbg_ptr, val);
    }
    /**
     * @param {string} code
     */
     ...
     */
    get_state() {
        const ret = wasm.emulator_get_state(this.__wbg_ptr);
        return ret;
    }
}
